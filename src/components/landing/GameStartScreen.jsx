...
export function GameStartScreen({ isOpen, onClose: _onClose, onBack, onStartPlaying }) {
    if (!isOpen) return null;

    return (
        <>
           <div 
           style={{background:" linear-gradient(140deg, #FFFBF5 0%, #FFF5E9 30%, #FFE8D6 60%, #FFD4B8 100%)"}} className="min-h-screen pb-8">
            ...
            <div className="z-40 flex flex-col items-center justify-center px-4 sm:px-6">
                  <div className="flex items-center gap-2 px-3 sm:px-4 py-3 sm:py-4 rounded-full bg-[#E9D4FF80] text-purple-700 font-semibold text-[10px] sm:text-[11px] uppercase tracking-[1.1px]">
                    ...
                    <span className="text-[#59168B]">Your Random Category</span>
                </div>
                        ...
                        <div className="relative bg-gradient-to-b from-gray-50 to-white flex flex-col sm:flex-row items-end justify-center rounded-t-[24px] sm:rounded-t-[40px] overflow-hidden p-4 sm:p-0">
                            ...
                            <div className="flex items-center justify-center w-full sm:w-[40%] mb-4 sm:mb-0">
                                <div className="relative sm:left-[40px] z-9">
                                    ...
                                    <img src="./landing/lion.png" alt="Lion" className="h-32 sm:h-full object-cover rounded-full" />
                            ...
                            <div className="flex flex-col items-center sm:items-start justify-center sm:pt-[30px] gap-[10px] sm:gap-[20px] w-full sm:w-auto">
                                <img src="./landing/puzzle.png" alt="Puzzle" className="w-24 sm:w-full h-auto object-cover sm:relative sm:right-[110px] sm:bottom-[30px] sm:top-[0px]" />
                                ...
                                <div className="bg-[#264DA7] text-white rounded-[20px] sm:rounded-[25px] p-4 sm:p-6 mb-[10px] sm:mb-[20px] sm:relative sm:right-[45px] shadow-[0_4px_0_0_#E17100] w-full sm:flex">
                                    ...
                                    <div className="w-full sm:w-[70%]">
                                        <h3 className="font-serif text-[24px] sm:text-[32px] font-bold mb-2">Animals</h3>
                                        <p className="text-white/90 text-[13px] sm:text-[14px] leading-relaxed">
                                            Let's see how well you know this category and test your skills with some fun exciting challenges ahead!
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="relative max-w-[750px] w-full text-white m-auto z-[99] rounded-[20px] sm:rounded-[28px] p-6 sm:p-10 shadow-[0_12px_40px_rgba(0,0,0,0.25)] overflow-hidden" style={{ background: 'linear-gradient(135deg, #101828 0%, #101828 50%, #1E2939 100%)' }}>
                    {/* Subtle glow */}
                    ...
                    <div
                        ...
                        style={{
                            top: '-19px',
                            left: '-6px',
                            background: 'linear-gradient(135deg, rgb(173, 70, 255) 10%, rgb(246 51 154 / 38%) 10%)',
                            filter: 'blur(80px)'
                        }}
                    />
                    ...
                    <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6">
                        ...
                        <div className="flex sm:w-[20%] items-center sm:flex-col sm:items-end gap-3 sm:gap-1 flex-shrink-0">
                            <div className="flex flex-col items-start sm:items-end">
                                ...
                                <span className="text-white font-bold text-[20px] sm:text-[24px]">$9/mo</span>
                            </div>
              ...
              <div className="bg-white">
                 <div className="absolute bottom-0 w-full relative top-[-70px] items-center justify-center h-[70px] bg-white">
